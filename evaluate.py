...
Evaluates the trained BloodCellCNN on the held-out BloodMNIST test set
(3,421 images, never seen during training or used to guide validation
decisions). Reports overall accuracy, per-class precision/recall/F1, and
saves an 8x8 confusion matrix to assets/confusion_matrix.png.
"""
...
from train import BloodMNISTDataset
